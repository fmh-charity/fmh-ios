//
//  UIModuleFilterNewsViewController.swift
//  fmh
//
//  Created: 05.06.2022
//
...
class UIModuleFilterNewsViewController: FMHUIViewControllerBase {
...
extension UIModuleFilterNewsViewController: UIPickerViewDelegate, UIPickerViewDataSource {
